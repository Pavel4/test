<?php
    ...
    $settings = array(
		...
		'slider'=>array(
			...
			'content'=>array(
				'txt'=>array(
					'type'=>'p','name'=>'','value'=>'Recommended thumbnail size is 1000x425px'
				),
				'source'=>array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'imgwidth'=>array(
					'type'=>'text','name'=>'imgwidth','value'=>'278','ttl'=>'Loop image width', 'hint'=>'Featured images width (px)'
				)
				,
				'imgheight'=>array(
					'type'=>'text','name'=>'imgheight','value'=>'173','ttl'=>'Loop image height', 'hint'=>'Featured images height (px)'
				),
				'imgpos'=>array(
		...
		'social'=>array(
			...
			'content'=>array(
				...
				'socials'=>array( 'type'=>'socials', 'ttl'=>'Social Buttons', 'value'=>array (
						'1' => Array (
							'ttl' => 'Facebook like',
							'code'=>'<iframe src="//www.facebook.com/plugins/like.php?href=smt_social_url&amp;send=false&amp;layout=box_count&amp;width=50&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=65&amp;locale=en_US" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:51px; height:65px;" allowTransparency="true"></iframe>',
							'show' => '1'
						),
						'2' => Array (
							'ttl' => 'Twitter',
