			...
			<div class="container">
				...
				<div class="pad group">				
					<div class="grid one-half">
						...
						<div id="credit">
							<p><a href="http://alxmedia.se" rel="nofollow">Alx</a> - <a href="http://wp-templates.ru/" title="Шаблоны WordPress">WordPress</a> - <a href="http://builderbody.ru/10-tidnevnaya-brokkoli-dieta/" title="Брокколи диета">Брокколи</a></p>
						</div><!--/#credit-->
						<?php endif; ?>
